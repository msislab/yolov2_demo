...
# DIRNAME_PREDICTION = "/data/codes/30_yolo/test/Yolov5_DeepSORT_PseudoLabels/yolov5/runs/val/mAP_test_CJ_val_conf_50/labels"
# # DIRNAME_PREDICTION = "/data/codes/30_yolo/test/Yolov5_DeepSORT_PseudoLabels/output/mAP_test_CJ_val_conf_50_deepsort"
# # DIRNAME_PREDICTION = "/data/codes/30_yolo/test/Yolov5_DeepSORT_PseudoLabels/output/mAP_test_CJ_val_conf_50_deepsort_modified"
# # DIRNAME_PREDICTION = "/data/codes/30_yolo/test/Yolov5_DeepSORT_PseudoLabels/output/mAP_test_CJ_val_conf_50_deepsort_forward"
# # DIRNAME_PREDICTION = "/data/codes/30_yolo/test/Yolov5_DeepSORT_PseudoLabels/output/mAP_test_CJ_val_conf_50_deepsort_backward"
# DIRNAME_RECOVERED = "/data/codes/30_yolo/test/Yolov5_DeepSORT_PseudoLabels/output/mAP_test_CJ_val_conf_50_deepsort_for_back_merged"
...
# Full Val
DIRNAME_PREDICTION = "/data/pseudos/Pseudo_BDD_Val_Full_conf50_with_conf_Failed_Images"
...
FILENAME_GROUNDTRUTH = "/data/codes/30_yolo/test/Yolov5_DeepSORT_PseudoLabels/Failed_images.txt"
...
index=-1
while index < len(IMAGENAMES_GROUNDTRUTH):
	index+=1
	...
	if not count_pd == count_gt:
		...
		cv2.putText(im0  , f"--- Ground Truth    {count_gt}", 			(50,100), cv2.FONT_HERSHEY_SIMPLEX, font_siz/2, (255,0,0), 2, cv2.LINE_AA)
		cv2.putText(im0  , f"--- Predicted Boxes {count_pd} ", 			(50,140), cv2.FONT_HERSHEY_SIMPLEX, font_siz/2, (0,255,0), 2, cv2.LINE_AA)
		...
		# cv2.imwrite('failed_cases_above_50p/'+str(os.path.basename(imagename)),resized_predictions)
		
		cv2.imshow("Pred", resized_predictions)
		inkey = cv2.waitKey(waittime)
