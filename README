...
# Data Handling
-   Check the argument module in server_full for handling labelled and training and validation data. Current module assumes the D4 should be the controller and will manage the data handling for self-training and validation. The code assumes the data directory paths which can be provided as inpute argument while running the code. e.g.
